...
export default function Hero() {
  return (
    <section className={`pt-32 pb-20 bg-gradient-to-b from-blue-50 via-indigo-50 to-white ${poppins.variable}`} style={{ fontFamily: 'var(--font-poppins)' }}>
      <div className="container mx-auto px-6">
        <div className="max-w-5xl mx-auto text-center space-y-8">
          ...
          <div className="flex items-center justify-center gap-4 pt-4">
            <Button className="bg-indigo-600 hover:bg-indigo-700 text-white rounded-full px-8 py-3 text-lg h-14 w-48 flex items-center justify-center">
              Start Project →
            </Button>
